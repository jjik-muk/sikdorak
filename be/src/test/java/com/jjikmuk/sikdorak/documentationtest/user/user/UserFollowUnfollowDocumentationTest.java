...
import static com.jjikmuk.sikdorak.documentationtest.user.user.UserSnippet.USER_FOLLOW_REQUEST_SNIPPET;
import static com.jjikmuk.sikdorak.documentationtest.user.user.UserSnippet.USER_FOLLOW_RESPONSE_SNIPPET;
