...
import static com.jjikmuk.sikdorak.acceptance.user.user.UserSnippet.USER_MODIFY_REQUEST_SNIPPET;
import static com.jjikmuk.sikdorak.acceptance.user.user.UserSnippet.USER_MODIFY_RESPONSE_SNIPPET;
